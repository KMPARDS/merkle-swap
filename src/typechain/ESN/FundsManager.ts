...
export abstract class FundsManager extends Contract {
   ...
   * @param _rawProof : RLP(ethBlockNumber, txIndex, rawTx, tx MPP, rawReceipt, receipt MPP).
   */
  abstract claimDeposit(_rawProof: BytesLike, overrides?: Overrides): Promise<ContractTransaction>;

  /**
   * Allows to submit a proof for a transaction done on ETH.
   * @param _rawProof : RLP(ethBlockNumber, txIndex, rawTx, tx MPP, rawReceipt, receipt MPP).
   */
  abstract 'claimDeposit(bytes)'(
    _rawProof: BytesLike,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract fundsManagerETH(overrides?: CallOverrides): Promise<string>;
  ...
  abstract reversePlasma(overrides?: CallOverrides): Promise<string>;
   ...
   * @param _tokenOnETH : Address of Era Swap ERC20 contract on ETH.
   */
  abstract 'setInitialValues(address,address,address)'(
    _reversePlasma: string,
    _tokenOnETH: string,
    _fundsManagerETH: string,
    overrides?: Overrides
