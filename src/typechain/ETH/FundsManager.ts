...
export abstract class FundsManager extends Contract {
  ...
  abstract interface: FundsManagerInterface;
   ...
   * @param _rawTransactionProof : RLP(bunchIndex, blockNumber, block MP, txRoot, rawTx, txIndex, tx MPP)
   */
  abstract 'claimWithdrawal(bytes)'(
    _rawTransactionProof: BytesLike,
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * FundsManager contract reference.
   */
  abstract fundsManagerESN(overrides?: CallOverrides): Promise<string>;
   ...
   * @param _transactionHash : Hash of the transaction.
   */
  abstract 'isTransactionClaimed(bytes32)'(
    _transactionHash: BytesLike,
    overrides?: CallOverrides
  ): Promise<boolean>;
   ...
   * Plasma Manager contract reference.
   */
  abstract plasmaManager(overrides?: CallOverrides): Promise<string>;
  ...
  abstract setFundsManagerESNAddress(
    _fundsManagerESN: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setFundsManagerESNAddress(address)'(
    _fundsManagerESN: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract setPlasmaManagerAddress(
    _plasmaManager: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setPlasmaManagerAddress(address)'(
    _plasmaManager: string,
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract setToken(_token: string, overrides?: Overrides): Promise<ContractTransaction>;

  abstract 'setToken(address)'(_token: string, overrides?: Overrides): Promise<ContractTransaction>;
