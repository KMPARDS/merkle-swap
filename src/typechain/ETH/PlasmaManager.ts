...
export abstract class PlasmaManager extends Contract {
  ...
  abstract interface: PlasmaManagerInterface;
   ...
   * @param _bunchIndex : Index of the bunch.
   */
  abstract 'getBunchHeader(uint256)'(
    _bunchIndex: BigNumberish,
    overrides?: CallOverrides
  ): Promise<{
    startBlockNumber: BigNumber;
   ...
   * Gets the start block number after last bunch.
   */
  abstract getNextStartBlockNumber(overrides?: CallOverrides): Promise<BigNumber>;
   ...
   * Gets index of last bunch header from bunch header list.
   */
  abstract lastBunchIndex(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  abstract setInitialValidators(
    _validators: string[],
    overrides?: Overrides
  ): Promise<ContractTransaction>;

  abstract 'setInitialValidators(address[])'(
    _validators: string[],
    overrides?: Overrides
  ): Promise<ContractTransaction>;
   ...
   * @param _txMRoot : Tx mega root of the blocks in the bunch
   */
  abstract 'submitBunchHeader(uint256,uint256,bytes32,bytes32,bytes32,bytes[])'(
    _startBlockNumber: BigNumberish,
    _bunchDepth: BigNumberish,
    _txMRoot: BytesLike,
    _rcMRoot: BytesLike,
