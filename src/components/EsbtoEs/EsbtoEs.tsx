      ...
      <div>
            ...
            <div className="container">
              <div className="row  mt80">
                ...
                <div className="col-lg-4 text-left ">
                  <h5 className="mrg-home text-left">Convert ESB to ES Na<br/>
                  <small className="text-warning font-weight-bold">Please load wallet first to Start transaction</small></h5>
                  ...
                  <Button className="btn btn-primary btn-color btn-lg btn-block text-white" onClick={handleShow}>
                      Swap Now
                  </Button>
                </div>
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body className="text-center mt40 mb40">
              <div><i className="fa fa-spinner fa-5x themetextcolor" aria-hidden="true"></i></div>
              <h4 className="text-center mt20 mb20 font-weight-bold "> Conversion in Progress</h4>
              <p><b>Note:</b> This is the one-way swap, once converted to ES Na, can`t be converted back to ESB</p>
          ...
          <Modal show={show1} onHide={handleClose1}>
            <Modal.Body className="text-center mt40 mb40">
              <div><i className="fa fa-spinner fa-5x themetextcolor" aria-hidden="true"></i></div>
              <h4 className="text-center mt20 mb20 font-weight-bold "> Please load wallet first to Start transaction</h4>
            
              <Button className="btn btn-primary btn-color btn-lg text-white mt10" onClick={handleClose1}>
                 Okay 
              </Button>
            </Modal.Body>
