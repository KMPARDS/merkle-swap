    ...
    <div>
            ...
            <div className="row  mt40">
              <div className="col-lg-12 text-left ">
                <div className=" text-center mt20 multiexchange-box">
                  <Tabs defaultActiveKey="insta" className="maintab" id="uncontrolled-tab-example">
                          ...
                          <Table responsive="sm">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>36:00:00</td>
                                <td>
                                  <a className="text-success" onClick={handleShow}>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Body className="text-center mt40 mb40">
          <div>
            <i className="fa fa-check fa-5x themetextcolor" aria-hidden="true"></i>
          </div>
          <h4 className="text-center mt20 mb20 font-weight-bold ">Conversion Successful</h4>
          <p>
            <b>Note:</b> Token Conversion is Successful
          </p>
          <Button
